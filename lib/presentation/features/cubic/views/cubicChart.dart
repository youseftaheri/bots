...
class CubicChartScreen extends StatefulWidget {
  final List<CubicData> cubicList;
  const CubicChartScreen({Key key, this.cubicList}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return CubicChartScreenState();
  }
}

class CubicChartScreenState extends State<CubicChartScreen> {
  ...
  void _initLineData(int count, double range) async {
    ...
    for (int i = 0; i < count; i++) {
      double val = (Util.changeRange(widget.cubicList[i].volume) * (range + 1)) + 20;
