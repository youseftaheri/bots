...
class MyBlockHeader extends StatelessWidget {
  final double width;
  final String title;
    ...
    return InkWell(
      ...
      child: Container(
        padding: EdgeInsets.only(
            top: AppSizes.sidePadding, right: AppSizes.sidePadding),
        child: Column(
                ...
                linkText != null
                    ? Container(
                        ...
                        child: Align(
                          ...
                          child:
                          Icon(Icons.fast_rewind_outlined, size: 30, color: AppColors.colorPrimary,),
